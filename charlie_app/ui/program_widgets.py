...
class Program(ttk.Frame):
    ...
    def create_widgets(self):
        ...
        camera_total_frames_label.grid(row=1, column=0)
        camera_total_frames_entry.grid(row=1, column=1)
        ...
        projector_total_frames_label.grid(row=1, column=4)
        projector_total_frames_entry.grid(row=1, column=5)
        projector_total_frames_entry.bind(
            '<KeyRelease>', self.set_projector_frames)
        projector_total_frames_entry.bind(
            '<FocusOut>', self.set_projector_frames)
        projector_reverse_option.grid(row=1, column=6)
